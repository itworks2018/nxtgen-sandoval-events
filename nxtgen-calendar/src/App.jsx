...
import { Plus, Pencil, Trash2, X, ChevronLeft, ChevronRight, MapPin, Users, Clock, StickyNote, ShieldCheck, Eye, CalendarDays, Loader2, Megaphone, AlertTriangle } from "lucide-react";
      ...
      <header style={styles.header}>
        <div style={styles.brandRow}>
          ...
          <div>
            ...
            <p style={styles.brandSub}>Calendar of the flock's gatherings</p>
          </div>
        </div>
      ...
      {showGate && (
        <div style={styles.overlay} onClick={() => setShowGate(false)}>
          <div style={styles.gateModal} onClick={(e) => e.stopPropagation()}>
            ...
            <h3 style={styles.gateTitle}>Enter teacher access code</h3>
            <p style={styles.gateSub}>Ask your ministry lead if you don't have it.</p>
            <input
              className="nxg-input"
              autoFocus
              type="password"
            ...
            <div style={styles.gateActions}>
              <button className="nxg-btn" style={styles.secondaryBtn} onClick={() => { setShowGate(false); setCodeInput(""); setGateError(""); }}>Cancel</button>
              <button className="nxg-btn" style={styles.primaryBtn} onClick={attemptUnlock}>Unlock</button>
            </div>
          </div>
        </div>
      )}
